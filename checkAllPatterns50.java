...
import java.lang.*;
public class checkAllPatterns50 
{
    ...
    {
        int length = 0;
        //actually the for loops should be from 0-36, rn they are 0-35
        for(int a = 0; a<mod;a++)
        {
                ...
                for(int c = 0; c<mod;c++)
                {
                    for(int d = 0; d<mod;d++)
                    {
                        ...
                        for(int i = 0; i<depth; i++)
                        {
                            ...
                            // }
                            if(correct(length) && lengthy(length) && length != 50)
                            {
                                System.out.println(" ");
                                System.out.println(a+" "+b+ " "+c+ " "+d);
                                System.out.print((length) + " ");
