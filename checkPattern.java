...
public class checkPattern 
{
    ...
    public static void rule14(int length)
    {
        int y = length/36;
        int temp = delete(solution.indexOf(18*y+8));
        insert(solution.indexOf(18*y+9), temp);
        int num1 = delete(solution.indexOf(18*y+5));
        int num2 = delete(solution.indexOf(18*y+6));
        solution.add(num2);
        solution.add(num1);
        solution.add(0);
    ...
    {
        int y = length/36;
        int temp = delete(solution.indexOf(18*y+3));
        insert(solution.indexOf(18*y+2), temp);

        temp = delete(solution.indexOf(18*y+10));
        insert(solution.indexOf(18*y+11), temp);
        
        int num3 = delete(solution.indexOf(18*y+9));
        int num4 = delete(solution.indexOf(18*y+4));
        delete(solution.indexOf(18*y+12));

        int num1 = delete(solution.indexOf(18*y-21));
        int num2 = delete(solution.indexOf(18*y-20));

        insert(solution.indexOf(18*y+21), length);
        insert(solution.indexOf(18*y+3), num3);
        insert(solution.indexOf(18*y+1), num4);
    ...
    public static void rule50(int length)
    {
        int y = length/36;
        int num1 = delete(solution.indexOf(18*y-8));
        int num2= delete(solution.indexOf(18*y-7));
        delete(solution.indexOf(18*y + 15));
        insert(solution.indexOf(18 *y +12), length);
        solution.add(num2);
        solution.add(num1);
        solution.add(0);
        while(solution.indexOf(-1)>-1)
